...
-- Started on 2024-12-10 19:17:40
...
COPY public.t_user_detail (id, user_id, is_active, token, login_date, logout_date) FROM stdin;
...
SELECT pg_catalog.setval('public.seq_employee_details_id', 1, false);
...
SELECT pg_catalog.setval('public.seq_employee_id', 1, false);
...
SELECT pg_catalog.setval('public.seq_employee_pay_info_id', 1, false);
...
SELECT pg_catalog.setval('public.seq_user', 13, true);
...
SELECT pg_catalog.setval('public.seq_user_detail_id', 16, true);
...
-- Completed on 2024-12-10 19:17:40
