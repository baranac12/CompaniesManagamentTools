...
import { Layout, Menu, Input, Button, Typography, message, Modal, Form } from "antd";
import { SearchOutlined, ExclamationCircleOutlined, UserAddOutlined } from "@ant-design/icons";
import UserCard from "../../shared/component/userCard";

import { deleteUser, getUser, updateUser, createUser } from "./api";
import { dropUser, updateUserInStore } from "../../redux/userSlice"; // updateUserInStore aksiyonunu import et
import { logout, login } from "../../redux/authSlice"; // login aksiyonunu import et
...
const User = () => {
    ...
    const onFinish = async (values) => {
        if (selectedUser) {
            ...
            try {
                ...
                setUsers((prevUsers) => [...prevUsers, createUserData]);
                form.resetFields();
                ...
                setErrorMessage(String(error.response?.data.password));
                setErrorModalVisible(true);
            }
        }
    };
    ...
    return (
        <Layout style={{ minHeight: "100vh", overflow: "hidden" }}>
            <Sider width={250} style={{ background: "#fff", padding: "20px", height: "100vh", overflow: "hidden" }}>
                <Button
                    type="primary"
                    style={{ marginBottom: 20, backgroundColor: "green", borderColor: "green", width: "200px" }}
                ...
                />
                <Menu mode="inline" style={{ height: "100%", borderRight: 0, overflowY: "hidden" }}>
            ...
            <Modal
                ...
                footer={[
                    <Button key="close" onClick={handleErrorModalClose}>Close</Button>
                ]}
            >
                <p>{errorMessage}</p>
            </Modal>
